...
namespace DebtManagment_DataAccessLayer       
{
    public static class clsClient_Data
    {
        ...
        ref string Email, ref string Phone, ref string Address,ref string SSN,
           ref string Commercial_Registration,ref int Classification)
        {
            bool isFound = false;
        ...
        public static bool UpdateClient(int ClientID,string Name, string Email, string Phone, string Address, string SSN, string Commercial_Registration, int Classification)
        {
        ...
        public static DataTable GetAllClients()
        {
            ...
            string query = @"SELECT tblClients.ClientID as م, tblPersons.Name as الأسم, 
		                    tblPersons.PhoneNumber as الرقم ,
		                    tblPersons.Email as الايميل,
		                    tblPersons.Address as العنوان,
		                    tblClients.SSN as 'الرقم الوطني', 
		                    tblClients.RemainderAmount as المتبقي
