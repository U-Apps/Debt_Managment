...
namespace DebtManagment_DataAccessLayer
{
    public class clsUser_Data
    {
        ...
        public static DataTable GetAllUsers()
        {
            ...
            string query = @"SELECT tblUsers.UserID, tblPersons.Name, tblPersons.PhoneNumber, tblPersons.Email, tblUsers.SSN, tblUsers.PersonalPicture, tblUsers.Username, tblUsers.Password
                        FROM     tblUsers INNER JOIN
                  tblPersons ON tblUsers.PersonID = tblPersons.PersonID";
